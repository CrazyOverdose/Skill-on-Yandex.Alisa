...
class las_vegas:
    ...
    questions = ['0', 'Чему равно 2+4-3*2', 'Какое из чисел натуральное? 0, 4, 0.2, 1/2',
                 ...
                 'При какой температуре (сколько градусов по Цельсия) замерзает вода?',
                 'Как называются кровеностные сосуды, которые уносят кровь из сердца?',
                 'Какая из стран (Ватикан, Турция, Саудовская Аравия, Иран) является светской?',
                 'Какая река протекает в Канаде? Нельсон, Амазонка, Янцзы, Ганг',
                 'Какая из этих жидкостей самая легкая? Бензин, оливковое масло, вода',
                 'В каком году христианство разделилось на православие и католицизм?',
                 'СКолько спутников у Земли?',
                 'Сколько рудиментов насчитывается в теле человека?',
                 'Какой стране принадлежит Гренландия?',
                 'Чему равен х в уравнении: 10х - 6х = 2',
                 'Что такое О3 в химии?',
    ...
    answers = ['0', '0', '4', 'Оттава', 'Сеул', 'е', 'ю', 'Грибоедов', 'нет', '6', '100000', '4', '0', 'артерии',
               'Турция', 'Нельсон', 'бензин', '1054', '1', '90', 'Дания', '0.5', 'озон',
               '6', '116', '10', '4', '32']

    fields = ['0', '\n 1. Cтарт \n', '\n 2. Колесо обозрения \"High Roller\" Цена: 10$ \n ',
              '\n 3. Инвесторы вложили в вас 100$\n',
...
COMMANDS = ['команды','список','список команд','чтоямогусделать','варианты','возможности', 'помощь', 'Помощь', 'Чтотыумеешь', 'чтотыумеешь']
...
def end(request, response, text):
    ...
    response.set_text(text + 'Давай напомню правила: В начале игры Алиса и пользователь имеют по 200$. Каждый участник бросает кубик и в зависимости от выпавшего количества очков перемещает фишку по полю. За каждый пройденный круг банк выплачивает 200$. Ваша цель – не обанкротиться. \n Если вы остановились на поле недвижимости и оно не куплено другими участниками, у вас есть право на его покупку или отказ от покупки. Владение недвижимостью дает право взыскивать арендную плату с человека, остановившегося на этом поле. Если вся недвижимость будет скуплена, стоимость попадания на чужую собственность увеличивается в 3 раза. \n\n Если вам не хватает средств на какие-то обязательные выплаты, вы становитесь банкротом. На каждой ячейке поля имеется подробная информация о действии этой клетки. Удачи...и пусть она всегда будет с вами.')
