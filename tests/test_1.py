...
class Test_9(unittest.TestCase):
    def test_rules(self):
        ...
        response = {
            ...
            "response": {
                "end_session": False,
                "text": "Каждый участник бросает кубик и в зависимости от выпавшего количества очков перемещает фишку "
                        "по полю. За каждый пройденный круг банк выплачивает 200$. Ваша цель – не обанкротиться. \n "
                        "Если вы остановились на поле недвижимости и оно не куплено другими участниками, у вас есть "
                        "право на его покупку или отказ от покупки. \n Владение зданием дает право взыскивать "
                        "арендную плату с человека, остановившегося на этом поле.\n \n Если вам не хватает средств на "
                        "какие-то обязательные выплаты, вы становитесь банкротом. \n \n Чтобы посмотреть все "
                        "доступные команды: \"команды\" \n Чтобы начать игру: \"бросить кубик\" "
            }
        }
